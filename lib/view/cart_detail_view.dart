...
class CartDetailView extends StatelessWidget {
  final CartModel snapshot;

  const CartDetailView({super.key, required this.snapshot});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ReUsableRow(title: 'Category', value: snapshot.categoryName),
              ...
              ReUsableRow(title: 'Price', value: snapshot.price),
              ReUsableRow(
                  title: 'Quantity', value: snapshot.quantity.toString()),
              ReUsableRow(title: 'Total Price', value: snapshot.totalPrice)
            ],
          ),
        ),
      ),
